package com.zhjf.osmdroid.permission;
...
public class PermissionManager {
     ...
     * 执行请求多个权限
     */
    public void execute(Activity activity, String... permissions) {
     ...
     * 执行请求一个权限
     */
    public void execute(Activity activity, String permission) {
        if (!isGranted(permission) && !isRevoked(permission)) {
     ...
     */
    public void executeDialog(Activity activity, String permission, Builder builder) {
        if (!isGranted(permission) && !isRevoked(permission)) {
     ...
     * 请求的方法
     */
    private void requestPerissins(Activity activity, String... permissions) {
        if (isM()) {
     ...
     * 这个方法可能不适合同时申请多个权限
     */
    public boolean shouldShowRequestPermissionRationale(Activity activity, String permission, Builder builder) {
