...
abstract class IIOParam {
     ...
     */
    protected Rect sourceRegion = null;
...
//        controller = defaultController;
    ...
    public void setSourceRegion(Rect sourceRegion) {
        ...
        this.sourceRegion = new Rect(sourceRegion.left, sourceRegion.top, sourceRegion.right, sourceRegion.bottom);
//        this.sourceRegion = (Rect)sourceRegion.clone();
    }
    ...
    public Rect getSourceRegion() {
        ...
        return new Rect(sourceRegion.left, sourceRegion.top, sourceRegion.right, sourceRegion.bottom);
//        return (Rect) sourceRegion.clone();
    }
